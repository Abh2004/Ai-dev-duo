...
import abhishekImage from "@/assets/images/WhatsApp Image 2025-04-19 at 01.14.58_a987a4e0.jpg";
import princeImage from "@/assets/images/prince.png";
...
const teamMembers: TeamMember[] = [
  {
    ...
    role: "Founder & CEO",
    bio: "Visionary technologist with 3+ years of experience in software development and AI. Abhishek founded Dev Duo with a mission to create cutting-edge digital solutions for businesses around the globe.",
    imgSrc: abhishekImage,
    links: {
      linkedin: "https://www.linkedin.com/in/abhishek-singh-maurya-621911217/",
      github: "https://github.com/abh2004",
      email: "arjunmaurya1920@gmail.com",
    },
    skills: [
      "AI & Machine Learning",
  ...
  },
  {
    ...
    name: "Prince Kumar",
    role: "Co-Founder & CTO",
    bio: "Technical leader specialized in emerging technologies and software engineering. Prince leads the technical direction of DevDuo, focusing on innovation and technical excellence.",
    imgSrc: princeImage, // Using imported image
    links: {
      linkedin: "https://www.linkedin.com/in/prince-kumar-072075228/",
      github: "https://github.com/ping-72",
      email: "kumarprince5511178@gmail.com",
    },
    skills: [
  ...
  },
  {
    ...
    imgSrc: vanshikaImage, // Using imported image
    links: {
      linkedin:
        "https://www.linkedin.com/in/vanshika-marwaha?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Our talented team combines creativity with technical expertise to
            deliver outstanding digital solutions. With diverse skills and
            backgrounds, we're united by a passion for innovation and
            excellence.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              {/* Skills */}
              <div className="mb-3">
                <h4 className="text-xs text-[#777] uppercase tracking-wider mb-2">
                  Expertise
                </h4>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-[#999] max-w-xl">
                ...
                about technology and innovation. Join us in our mission to
