      ...
      <div className="container mx-auto px-4 relative z-10 pt-12 md:pt-16 pb-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            >
              <div className="bg-[#0066FF] w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center mr-2 relative" 
                ...
                <div className="bg-[#030308] w-5 h-5 sm:w-7 sm:h-7 flex items-center justify-center absolute" 
                     style={{clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)'}}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-8 md:mb-12 bg-[#060610] rounded-lg p-4 md:p-6">
          ...
          <div className="flex items-center p-2">
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#0A0A15] flex items-center justify-center mr-3 sm:mr-4 border border-[#1a1a2a]">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0066FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                <circle cx="12" cy="10" r="3"></circle>
              </svg>
            </div>
            <div>
              <h4 className="text-white text-xs sm:text-sm font-display font-medium uppercase tracking-wider">Office Location</h4>
          ...
          <div className="flex items-center p-2">
            ...
            <div>
              <h4 className="text-white text-xs sm:text-sm font-display font-medium uppercase tracking-wider">Email Us</h4>
          ...
          <div className="flex items-center p-2">
            ...
            <div>
              <h4 className="text-white text-xs sm:text-sm font-display font-medium uppercase tracking-wider">Call Us</h4>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center border-t border-[#111] pt-6 md:pt-8">
          ...
          <div className="flex flex-wrap justify-center md:justify-end gap-4 md:gap-6">
            ...
            <motion.div whileHover={{ y: -2 }} transition={{ type: "spring", stiffness: 500 }}>
              <a href="#" className="text-[#777] hover:text-[#0066FF] text-xs sm:text-sm font-display uppercase tracking-wider transition-all duration-300 relative group">
                Privacy Policy
                <motion.span 
                  className="absolute left-0 -bottom-1 w-0 h-[1px] bg-[#0066FF] group-hover:w-full transition-all duration-300"
                  initial={{ width: "0%" }}
