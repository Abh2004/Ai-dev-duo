      ...
      >
        <div className="relative max-w-4xl mx-auto text-center mb-20">
          ...
          <div 
            ...
            style={{
              background: 'radial-gradient(circle at center, #0066FF 0%, rgba(0, 102, 255, 0) 70%)',
              width: '300px',
              height: '300px',
              borderRadius: '50%',
          ...
          >
            Learn about our team, mission, and the technology expertise that powers our innovative solutions. 
            We're driven by creativity and committed to exceeding client expectations on every project.
          </motion.p>
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <p className="text-[#BBB] mb-10">
              Our team of experts is ready to help you build innovative solutions for your business challenges.
            </p>
            <motion.a 
              href="/contact" 
